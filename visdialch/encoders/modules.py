...
from .context_att import CONTEXT_ATT_MODULE as ATT_MODULE

class ATT_MODULE_OLD(nn.Module):
    """docstring for ATT_MODULE"""
    def __init__(self, config):
        super(ATT_MODULE_OLD, self).__init__()
    ...
    def forward(self, img, ques):
        ...
        # img shape, Faster R-CNN : (batch_size, 36, 2048)
        # ques shape : (batch_size, 1, 300)
